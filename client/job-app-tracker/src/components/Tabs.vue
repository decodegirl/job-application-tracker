                  ...
                  <v-flex xs6>
                    ...
                    <v-layout row wrap>
                      ...
                      <v-flex xs12>
                        ...
                        <input type="text" v-model="job.salary" flat rounded />
                      </v-flex>
                      <v-flex xs12>
                  ...
                  <v-flex xs6>
                    ...
                    <v-layout row wrap>
                      ...
                      <v-flex xs12>
                        ...
                        <input type="text" v-model="job.applied" flat rounded />
                      </v-flex>
                      <v-flex xs12>
                      ...
                      <v-flex xs12>
                        <strong>Offer: </strong>
                        <input type="text" v-model="job.offer" flat rounded />
                      </v-flex>
                    </v-layout>
                  </v-flex>
            ...
            <v-card flat v-if="page.tab_title == 'Directory'" class="ma-4">
              <v-layout row wrap>
                <v-flex xs6>
                  ...
                  <p class="pr-4">
                    Find contact information for people who work at Reddit.
                    Search by role, so you can get your resume in front of the
                    most appropriate person. Results include email, names,
                    titles, and even social media profiles.
                  </p>
                </v-flex>
